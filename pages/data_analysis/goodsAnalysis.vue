            ...
            <a-row :gutter="16">
              <a-col :span="6">
                <a-card :bordered="false" style="height: 200px">
                  <span class="sellhead">总支出</span><br>
                  <span class="totalsell">￥126,560</span><br>
                  <span>周同比</span>&nbsp;&nbsp;<span>12%</span>&nbsp;&nbsp;&nbsp;&nbsp;
                  <span>日环比</span>&nbsp;&nbsp;<span>11%</span>
                  <a-divider />
                  <span class="sellhead">日均支出</span>&nbsp;&nbsp;<span class="sellhead">￥12,423</span>
                </a-card>
              </a-col>
              <a-col :span="6">
                <a-card :bordered="false" style="height: 200px">
            ...
            <a-row :gutter="16">
              <a-col :span="12">
                <a-card :bordered="false">
                  <span class="medium-head">最多消耗物资</span>
                  <br><br>
                  <a-table
              ...
              <a-col :span="12">
                <a-card :bordered="false">
                  <span class="medium-head">消耗物资占比</span>
