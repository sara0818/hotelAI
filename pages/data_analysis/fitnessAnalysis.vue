      ...
      <a-layout :style="{ marginLeft: '200px',top:'15px'}">
        <a-layout-content :style="{ margin: '64px 16px 0', overflow: 'initial' }">
          <div>
            <a-row :gutter="16">
              ...
              <a-col :span="6">
                <a-card :bordered="false"  style="height: 200px">
                  <span class="sellhead">健身高峰期</span><br>
                  <span class="totalsell">18：00~21：00</span><br>
                  <div id="main2" style="height: 60px;width: 200px"></div>
                  <span class="sellhead"></span>&nbsp;&nbsp;<span class="sellhead">60%</span>
                </a-card>
              </a-col>
              <a-col :span="6">
                <a-card :bordered="false"  style="height: 200px">
                  <span class="sellhead">当前健身房占用率</span><br>
        ...
        <a-layout-content :style="{ margin: '16px 16px 0', overflow: 'initial' }">
          <div :style="{ padding: '24px', background: '#fff', textAlign: 'center',height:'450px' }">
            <span class="medium-head">本年销售额/健身人数</span>
            ...
            <a-row :gutter="16">
              <a-col :span="12">
                <a-card :bordered="false">
                  <span class="medium-head">热门器材品</span>
                  <br><br>
                  <a-table
              ...
              <a-col :span="12">
                <a-card :bordered="false">
                  <span class="medium-head">器材使用类别占比</span>
        ...
        <a-layout-content :style="{ margin: '16px 16px 0', overflow: 'initial' }">
          <div :style="{ padding: '24px', background: '#fff', textAlign: 'center',height:'450px' }">
            ...
            <div id="main6" style="height: 400px;width: 1200px" align="center"></div>
          </div>
        </a-layout-content>
